...
def llm_extract_anchors(text, mode="fine", model="gpt-4.1"):
    if mode == "fine":
        prompt = f"""
...
def extract_anchors(input_path, output_filename, model="gpt-4.1", mode="both"):
    print(f"\n🔍 正在提取锚点：{input_path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="gpt-4.1", help="使用的模型名称")
