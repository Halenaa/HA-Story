...
result = match_items(ref, gen, field="surface")
results.append({
    "story": "小红帽",
    "type": "surface",
...
result = match_items(ref, gen, field="type")
results.append({
    "story": "小红帽",
    "type": "functional",
    "hit_rate": result["hit_rate"],
...
with open('structure_match_summary.csv', 'w', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=['story', 'type', 'hit_rate'])
    writer.writeheader()
    writer.writerows(results)
print('\n✅ 匹配统计已保存到 structure_match_summary.csv')