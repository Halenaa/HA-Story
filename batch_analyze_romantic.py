...
def main():
    """主函数"""
    # 设置路径
    romantic_test_dir = "/Users/haha/Story/data/output/romantic_test"
    output_dir = "/Users/haha/Story/data/romantic_test_analysis"
    
    print("开始批量分析romantic_test文件夹...")
    print(f"源目录: {romantic_test_dir}")
    ...
    for item in os.listdir(romantic_test_dir):
        item_path = os.path.join(romantic_test_dir, item)
