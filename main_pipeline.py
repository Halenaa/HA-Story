...
def main(version="test", reorder_mode="random", use_cache=True, topic="小红帽", style="科幻改写", behavior_model="gpt-4o"):
    print(f"\n开始运行 main_pipeline")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--behavior-model", type=str, default="gpt-4o", help="行为识别使用的模型")
